...
<Quiz
  ...
  answer={1}
  explanation="Sites that share an IP but are absent from public DNS are found by varying the Host header (virtual host discovery), not by DNS brute forcing or directory brute forcing. nikto is noisy and would not surface unlinked vhosts. WHOIS yields nothing new here."
/>
