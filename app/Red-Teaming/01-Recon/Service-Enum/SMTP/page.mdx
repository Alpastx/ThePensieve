...
description: "Enumerate and attack SMTP. Cover user enumeration, email spoofing (SPF/DKIM/DMARC), open relay testing, version-specific RCE, and mailbox pillaging."
openGraph:
  title: "SMTP - Ports 25, 587, 465"
  description: "Enumerate and attack SMTP. Cover user enumeration, email spoofing (SPF/DKIM/DMARC), open relay testing, version-specific RCE, and mailbox pillaging."
  images:
